...
def build_combat_system_prompt(ctx: dict, memory_context: str = "") -> str:
    ...
    # ═══════════════════════════════════════════════════════════════
    # БЛОК ПАМЯТИ: всплывающие воспоминания из прошлых боёв и диалогов
    # ═══════════════════════════════════════════════════════════════
    memory_block = ""
...
═══════════════════════════════════════════════════════════════════
Ниже — твоя память. Но ты не читаешь отчёт. Ты ВСПОМИНАЕШЬ.
Преврати сухие факты в ЖИВЫЕ ощущения: запах крови, звук клинка, дрожь рук, вкус страха или гордости.
Пусть в речь просочится ОДИН яркий образ — не список событий.
